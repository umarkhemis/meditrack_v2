...
import {
  ...
  LogOut, ChevronRight, Activity, CalendarClock, Bell, X, Menu
} from 'lucide-react'
...
export default function Layout({ children }) {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div className="sidebar-desktop" style={{ position: 'fixed', top: 0, left: 0, height: '100vh', zIndex: 100 }}>
        <Sidebar />
      </div>
      ...
      {/* Main content */}
      <main style={{ marginLeft: 240, flex: 1, minHeight: '100vh', display: 'flex', flexDirection: 'column' }} className="main-content">
        {/* Mobile top bar */}
        <div className="mobile-topbar" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontWeight: 700, fontSize: 15, color: 'var(--text)', letterSpacing: '-0.02em' }}>MediTrack</span>
          </div>
          {unreadCount > 0 && (
            <span style={{
        ...
        <div style={{ flex: 1, padding: '32px 36px', maxWidth: 1320 }} className="page-content">
          {children}
        </div>
      </main>
